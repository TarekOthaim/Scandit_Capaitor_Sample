...
/* harmony export */   "SettingsService": () => (/* reexport safe */ _settings_service__WEBPACK_IMPORTED_MODULE_0__.SettingsService),
/* harmony export */   "UiService": () => (/* reexport safe */ _ui_service__WEBPACK_IMPORTED_MODULE_1__.UiService)
/* harmony export */ });
/* harmony import */ var _settings_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./settings.service */ 70452);
/* harmony import */ var _ui_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ui.service */ 79846);
...
/* harmony import */ var _shared_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../shared/utils */ 82846);
...
let SettingsService = class SettingsService {
    constructor(formBuilder) {
        ...
        this.symbologies = (0,_config__WEBPACK_IMPORTED_MODULE_0__.fieldsStructure)(Scandit).barcodeSelection.symbologies
            .reduce((symbologies, symbology) => (Object.assign(Object.assign({}, symbologies), { [symbology]: {
        ...
        this.settingsForm = this.buildFormPart((0,_config__WEBPACK_IMPORTED_MODULE_0__.fieldsStructure)(Scandit));
    }
    get barcodeSelectionForm() {
        return this.settingsForm.controls.barcodeSelection;
    }
    get symbologiesForm() {
        return this.barcodeSelectionForm.controls.symbologies;
    }
    get barcodeSelectionPointOfInterestForm() {
        return this.barcodeSelectionForm.controls.pointOfInterest;
    }
    get selectionTypeForm() {
        return this.barcodeSelectionForm.controls.selectionType;
    }
    get feedbackForm() {
        return this.barcodeSelectionForm.controls.feedback;
    }
    get codeDuplicateFilterForm() {
        return this.barcodeSelectionForm.controls.codeDuplicateFilter;
    }
    get singleBarcodeAutoDetectionForm() {
        return this.barcodeSelectionForm.controls.singleBarcodeAutoDetection;
    }
    get cameraForm() {
        return this.settingsForm.controls.camera;
    }
    get viewForm() {
        return this.settingsForm.controls.view;
    }
    get scanAreaForm() {
        return this.viewForm.controls.scanArea;
    }
    get pointOfInterestForm() {
        return this.viewForm.controls.pointOfInterest;
    }
    get overlayForm() {
        return this.viewForm.controls.overlay;
    }
    get viewfinderForm() {
        return this.viewForm.controls.viewfinder;
    }
    buildFormPart(config) {
        if ((0,_shared_utils__WEBPACK_IMPORTED_MODULE_1__.isArray)(config)) {
            return this.formBuilder.group(this.getFormConfigFromFields(config));
        }
        if ((0,_shared_utils__WEBPACK_IMPORTED_MODULE_1__.isObject)(config)) {
            const group = Object.keys(config)
                .reduce((current, key) => (Object.assign(Object.assign({}, current), { [key]: this.buildFormPart(config[key]) })), {});
            return this.formBuilder.group(group);
        }
    }
    getFormConfigFromFields(fields) {
        return fields.reduce((value, field) => (Object.assign(Object.assign({}, value), { [field]: this.getFieldConfig(field) })), {});
    }
    getFieldConfig(field) {
        ...
        if (Scandit.Symbology[field]) {
            ...
            const hasExtensions = ((_a = description.supportedExtensions) === null || _a === void 0 ? void 0 : _a.length) || ((_b = symbology.enabledExtensions) === null || _b === void 0 ? void 0 : _b.length);
            const extensions = hasExtensions ? { extensions: this.formBuilder.control(symbology.enabledExtensions) } : {};
            const rangeEnabled = (description === null || description === void 0 ? void 0 : description.activeSymbolCountRange) &&
            ...
            return this.formBuilder.group(Object.assign(Object.assign(Object.assign(Object.assign({}, enabled), colorInverted), extensions), range));
        }
        return this.formBuilder.control((0,_config__WEBPACK_IMPORTED_MODULE_0__.settingsFields)(Scandit)[field].defaultValue);
    }
};
SettingsService.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormBuilder }
];
SettingsService = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "isArray": () => (/* reexport safe */ _type_check__WEBPACK_IMPORTED_MODULE_0__.isArray),
/* harmony export */   "isBoolean": () => (/* reexport safe */ _type_check__WEBPACK_IMPORTED_MODULE_0__.isBoolean),
/* harmony export */   "isFunction": () => (/* reexport safe */ _type_check__WEBPACK_IMPORTED_MODULE_0__.isFunction),
/* harmony export */   "isNumber": () => (/* reexport safe */ _type_check__WEBPACK_IMPORTED_MODULE_0__.isNumber),
/* harmony export */   "isObject": () => (/* reexport safe */ _type_check__WEBPACK_IMPORTED_MODULE_0__.isObject),
/* harmony export */   "isString": () => (/* reexport safe */ _type_check__WEBPACK_IMPORTED_MODULE_0__.isString)
/* harmony export */ });
/* harmony import */ var _type_check__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./type-check */ 67876);
...
/***/ 67876:
/*!********************************************!*\
  !*** ./src/app/shared/utils/type-check.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _Volumes_Macintosh_HD2_ionic_apps_othim_apps_ScanDit_Capacitor_Work_BarcodeCaptureViewsSample_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 71670);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,_Volumes_Macintosh_HD2_ionic_apps_othim_apps_ScanDit_Capacitor_Work_BarcodeCaptureViewsSample_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,_Volumes_Macintosh_HD2_ionic_apps_othim_apps_ScanDit_Capacitor_Work_BarcodeCaptureViewsSample_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_Volumes_Macintosh_HD2_ionic_apps_othim_apps_ScanDit_Capacitor_Work_BarcodeCaptureViewsSample_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
